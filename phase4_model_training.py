"""
PHASE 4: MODEL TRAINING (RETURN-BASED - FIXES DISTRIBUTION SHIFT)
...
print(f"\n  ⚠️  TARGET: gold_return_next (log return). Back-transform: current_gold * exp(return)")
...
lgb_model.fit(X_train, y_train_return)
...
# ============================================================================
# MODEL 6: ENSEMBLE (AVERAGE OF XGBOOST, LIGHTGBM, RF, RIDGE)
# ============================================================================
print("\n" + "=" * 80)
...
results_df = pd.DataFrame({
    'Model': ['XGBoost', 'LightGBM', 'Random Forest', 'Ensemble', 'Naive Baseline'],
    'Train_RMSE': [xgb_train_metrics['rmse'], lgb_train_metrics['rmse'],
                   rf_train_metrics['rmse'],  ensemble_train_metrics['rmse'], naive_train_metrics['rmse']],
    'Train_MAE':  [xgb_train_metrics['mae'],  lgb_train_metrics['mae'],
                   rf_train_metrics['mae'],   ensemble_train_metrics['mae'],  naive_train_metrics['mae']],
    'Train_R2':   [xgb_train_metrics['r2'],   lgb_train_metrics['r2'],
                   rf_train_metrics['r2'],    ensemble_train_metrics['r2'],   naive_train_metrics['r2']],
    'Val_RMSE':   [xgb_val_metrics['rmse'],   lgb_val_metrics['rmse'],
                   rf_val_metrics['rmse'],    ensemble_val_metrics['rmse'],   naive_val_metrics['rmse']],
    'Val_MAE':    [xgb_val_metrics['mae'],    lgb_val_metrics['mae'],
                   rf_val_metrics['mae'],     ensemble_val_metrics['mae'],    naive_val_metrics['mae']],
    'Val_R2':     [xgb_val_metrics['r2'],     lgb_val_metrics['r2'],
                   rf_val_metrics['r2'],      ensemble_val_metrics['r2'],     naive_val_metrics['r2']],
    'Test_RMSE':  [xgb_test_metrics['rmse'],  lgb_test_metrics['rmse'],
                   rf_test_metrics['rmse'],   ensemble_test_metrics['rmse'],  naive_test_metrics['rmse']],
    'Test_MAE':   [xgb_test_metrics['mae'],   lgb_test_metrics['mae'],
                   rf_test_metrics['mae'],    ensemble_test_metrics['mae'],   naive_test_metrics['mae']],
    'Test_R2':    [xgb_test_metrics['r2'],    lgb_test_metrics['r2'],
                   rf_test_metrics['r2'],     ensemble_test_metrics['r2'],    naive_test_metrics['r2']]
})
